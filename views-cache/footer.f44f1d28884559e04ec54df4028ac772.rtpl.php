            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Pray Store</h2>
                        <p>E um site a onde voce podera comprar produtos em mais alta qualidade, com um preço acessivel !</p>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2020 Pray Store. <a href="http://www.http://www.precommerce.com.br/" target="_blank">precommerce.com.br</a></p>
                    </div>
                </div>
